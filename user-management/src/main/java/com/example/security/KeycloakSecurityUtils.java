...
//	     public UserRepresentation fetchUserFromKeycloak(String token, String userId) throws Exception {
//	        Keycloak keycloak = KeycloakBuilder.builder()
